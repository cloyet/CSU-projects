"""Program Begin HERE
Some data Exploration using Python. Assuming that all needed packages are already installed for your IDE to find them"""
...
# Createa data_frame of array values
df=pd.DataFrame({
...
#validate first to check if samples in 0.25 time data or not
...
# END extract of 25% sample of data
